...
class StoredSongRVAdapter() :
    RecyclerView.Adapter<StoredSongRVAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): StoredSongRVAdapter.ViewHolder {
